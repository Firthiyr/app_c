    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requires_delivery', models.BooleanField(default=False, verbose_name='Потріба доставка')),
                ...
                ('status', models.CharField(default='В обробці', max_length=50, verbose_name='Статус замолвення')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orders.order', verbose_name='Замолвення')),
